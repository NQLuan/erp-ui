        ...
        <div id="id_leaves" class="main-leaves row p-3">
            <div class="col-sm-9 mx-auto">
                ...
                <form id="leaves" class="bg-white px-4 text-info" method="POST" @submit.prevent="handleClicktoModal('on')">
                    <div v-if="error !== ''" class="text-danger text-center my-2">
                        {{ error }}
                    </div>
                    <br>
                ...
                <b-modal ref="certification_modal" hide-footer title="Leave" class="font-weight-bold">
                    <div class="d-block ml-5 pt-3">
                        <div>
                            <div><strong>User:</strong> {{user_name}}</div><br>
                            <div><strong>From:</strong> {{startday}} {{selectedTime.hour}}:{{selectedTime.min}}</div><br>
                            <div><strong>To:</strong> {{endday}} {{selectedNextTime.hour}}:{{selectedNextTime.min}}</div><br>
                            <div><strong>Type:</strong> {{title}}</div><br>
                            <div><strong>Reason:</strong> {{reason}}</div><br>
                            <div><strong>Lunch:</strong> {{selected}}</div><br>
                        </div>
                    </div>
