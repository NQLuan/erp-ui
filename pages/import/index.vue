    ...
    <div class="main-content d-flex justify-content-center">
        ...
        <div class="table-responsive p-3 col-md-6 col-lg-9">
            ...
            <form id="id_import" class="p-4 text-info " method="POST" @submit.prevent="checkfile" @keyup.enter="checkfile">
                ...
                <div v-show="this.files !== ''" class="form-group row">
                ...
                <div v-show="this.files !== ''" class="form-group row">
                    <div class="col-md-2">
                        <button v-show="this.showbutton" type="submit" class="btn btn-info">
                            Import
                        </button>
                        <button v-show="!this.showbutton" type="submit" class="btn btn-warning" disabled>
                            Waiting...
                        </button>
                    </div>
                </div>
            ...
            <p>{{ this.error_msg }}</p>
            <div v-if="!this.success && this.sent">
                <p class="text-success">Success: {{ this.valid.length }}</p>
                <p class="text-danger">Failure : {{ this.invalid.length }}</p>
            ...
            <div v-if="this.sent">
                <button v-show="this.showbutton && this.valid.length !== 0" @click="submitfile()" class="btn btn-success">
                    Confirm
                </button>
                <button v-show="this.showbutton" @click="cancelfile()" type="submit" class="btn btn-danger">
                    Cancel
                </button>
            </div>
        </div>
