    ...
    <div class="main-content ml-0">
        ...
        <div v-if="!checked" class="mt-5 col-6 mx-auto">
            ...
            <div class="d-flex justify-content-center card-body my-auto py-5">
                <nuxt-link v-show="admin==='true'" class="btn btn-info float-right px-4 py-2 mr-4 text-uppercase font-weight-bold" to="/createteam/">
        ...
        <div v-if="checked" id="id_team_table" class="table-responsive p-3">
            <div class="row">
                <nuxt-link v-show="admin==='true'" class="btn btn-info ml-auto float-right px-4 py-2 mr-3 my-2 text-uppercase font-weight-bold" to="/createteam/">
                    <font-awesome-icon :icon="['fas', 'user-friends']"/>
                    Create Team
                </nuxt-link>
            </div>
            <table class=" table table-bordered table-striped table-rounded table-fixed">
                ...
                <tbody>
                    <tr v-for="row in sortTermFunction(rows)" :key="row.index">
                        ...
                        <td>
                            <nuxt-link :to="'/team/' + row.id" :class="{ 'text-danger': row.leader_name === 'No leader' }" title="Click to move to another page">
                                {{ row.leader_name }}
                            </nuxt-link>
                        </td>
                        <td>
                            <nuxt-link :to="'/team/' + row.id" title="Click to move to another page">
                                {{ row.employee_number }}
                            </nuxt-link>
                        </td>
            ...
            <b-modal ref="mymodal" hide-footer hide-header="">
                ...
                <div class="d-block text-center mb-4">
                    Do you want to remove team <p class="text-danger d-inline">{{this.currentteamname}}</p>
                </div>
                <div class="row">
