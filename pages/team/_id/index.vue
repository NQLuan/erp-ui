    ...
    <div class="main-content ml-0">
        ...
        <div class="text-danger">
         ...
         <div class="p-3">
            <div class="row" v-if="show" @dblclick="showEdit()">
                ...
                <nuxt-link v-show="admin === 'true' || team_leader_id.toString() === profile_id" :to="'/editteam/' + this.team_id" class="btn btn-info ml-auto float-right px-4 py-2 mr-3 my-2 text-uppercase font-weight-bold">
                    <font-awesome-icon :icon="['fas', 'edit']"/>
                    Edit Team
                </nuxt-link>
                <nuxt-link v-show="admin === 'true' || team_leader_id.toString() === profile_id" :to="'/addMember/' + this.team_id" class="btn btn-info float-right px-4 py-2 mr-3 my-2 text-uppercase font-weight-bold">
                ...
                <tbody>
                    <tr v-for="row in sortFunction(rows)" :key="row.index">
                        <td scope="row">
                            ...
                            <img v-if="row.image === null" class="img-fluid" src="/images/icon.png" /> 
                        </td>
                        <td scope="row">
                            <nuxt-link :to="'/profile/' + row.id" title="Click to move to Profile page">
        ...
        <b-modal id="mymodal" ref="mymodal" hide-footer hide-header>
            ...
            <div class="d-block text-center mb-4">
                Do you want to remove <p class="text-danger d-inline">{{ this.currentname }}</p> from team?
            </div>
            <div class="row">
