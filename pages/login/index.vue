<template>
    <div class="background">
        <center>
            <img class="icon" src="images/logo-paradox-white-01.png" />
        </center>
                        ...
                        <div class="border-bottom">
                            <div class="pt-2 pb-2">
                                <table>
                                    <tbody>
                                        <tr>
                                            <td class="alert alert-danger mb-2" v-show="this.forgot_pass_error.title !== ''">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="col-sm-12 mx-auto mb-2">
                                                    <input type="text" id="identify_email" class="w-100 p-1"  name="email" placeholder="Email address" autofocus="1" aria-label="email address" v-model="email_to_get_password">
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="alert alert-success mb-2">
                                                Reset password link had been sent to email {{this.email_to_get_password}}. 
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
    ...
    methods: {
        submit_forgotPass_box() {
            if (this.email_to_get_password === '') {
                ...
                this.$axios.post(`/actions/forgot_password/`, formdata).then((res)=> {
