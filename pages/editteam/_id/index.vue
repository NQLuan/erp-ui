            ...
            <form id="profile" class="bg-white p-4 text-info">
                ...
                <div class="form-group row my-3">
                    ...
                    <div class="col-sm-8 ml-2">
                        <input id="id_input_teamname" v-model="team_name" type="text" class="form-control" :placeholder="this.team_name" required />
                    </div>
                </div>
                <div class="form-group row my-3">
                    <label for="input_name" class="col-sm-3 col-form-label">Team Email</label>
                    <div class="col-sm-8 ml-2">
                        <input id="id_input_teamname" v-model="team_email" type="text" class="form-control" :placeholder="this.team_email" required/>
                    </div>
                </div>
            </form>
            <br>
