    ...
    <div class="main-content">
        ...
        <div v-if="!checked" class="mt-5 col-6 mx-auto">
            ...
            <div v-show="admin === 'true'" class="d-flex justify-content-center card-body bg-light my-auto py-5">
                <nuxt-link to="/invite" class="btn btn-info float-right px-4 py-2 mr-4 text-uppercase font-weight-bold">
                    <font-awesome-icon :icon="['fas', 'user-plus']"/>
                    INVITE
                </nuxt-link>
                <nuxt-link to="/import" class="btn btn-info float-right px-4 py-2 mr-4 text-uppercase font-weight-bold">
        ...
        <div v-if="checked" id="id_list_table" class="table-responsive p-3">
            <div class="row mb-2">
                ...
                <nuxt-link v-show="admin === 'true'" to="/invite" class="btn btn-info float-right px-4 py-2 mr-3 text-uppercase font-weight-bold">
                    <font-awesome-icon :icon="['fas', 'user-plus']"/>
                    INVITE
                </nuxt-link>
                <nuxt-link v-show="admin === 'true'" to="/import" class="btn btn-info float-right px-4 py-2 mr-3 text-uppercase font-weight-bold">
                    <font-awesome-icon :icon="['fas', 'file-import']"/>
                    IMPORT FILE
                </nuxt-link>
            </div>
                    ...
                    <tr v-show="search === ''" v-for="row in  sortFunction(rows)" :key="row.index">
                        <td scope="row" class="text-center">
                            <nuxt-link :to="'/profile/' + row.id">
                                ...
                                <img class="img-fluid" src="/images/icon.png" v-if="row.image === null"/> 
                            </nuxt-link>
                        </td>
